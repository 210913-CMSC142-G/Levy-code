...
class Joba
{
	...
	public Joba(char id, int deadline, int profit)
	{
		this.id = id;
	...
	void printJobScheduling(ArrayList<Joba> arr, int t)
	{
		// Length of array
		int n = arr.size();
	...
	{
		ArrayList<Joba> arr = new ArrayList<Joba>();
		//can modify the id, deadline and profit 
		arr.add(new Joba('a', 4, 20));
		arr.add(new Joba('b', 1, 10));
		arr.add(new Joba('c', 1, 40));
		arr.add(new Joba('d', 1, 30));
